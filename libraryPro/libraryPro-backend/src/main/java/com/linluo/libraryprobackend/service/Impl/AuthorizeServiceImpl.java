package com.linluo.libraryprobackend.service.Impl;

import com.linluo.libraryprobackend.entity.auth.Account;
import com.linluo.libraryprobackend.mapper.UserMapper;
import com.linluo.libraryprobackend.service.AuthorizeService;
...
public class AuthorizeServiceImpl implements AuthorizeService {
    ...
    public String sendValidateEmail(String email,String sessionId,boolean hasAccount) {
        /**
         * 1.先生成对应的验证码
         * 2.把邮箱和对应的验证码直接放到Redis里面(过期时间3分钟，
         * 如果此时要求重新发邮件，那么只要剩余时间低于2分钟，就可以重新发送一次，重复此流程)
         * 3.发送验证码到指定邮箱
         * 4.如果发送失败，把Redis里面的刚刚插入的键值对删除
        ...
        message.setTo(email);
        message.setSubject("[LibraryPro]您的验证邮件~");
